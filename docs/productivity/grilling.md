...
`grilling` is the interview **primitive** under the main build chain: [grill-with-docs](../engineering/grill-with-docs.md) runs it to sharpen context before [to-spec](../engineering/to-spec.md) writes the spec. When you're unsure which entry point fits, [ask-galo](../engineering/ask-galo.md) routes you.
