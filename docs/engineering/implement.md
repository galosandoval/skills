...
```bash
npx skills add galosandoval/skills --skill=implement
```
...
[Source](../../skills/engineering/implement)
...
[ask-galo](./ask-galo.md) is the router over the whole set when you are not sure which flow you are in.
