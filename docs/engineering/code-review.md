...
```bash
npx skills add galosandoval/skills --skill=code-review
```
...
[ask-galo](./ask-galo.md) routes across the whole set when you are unsure which skill the situation wants.
