---
"galosandoval-skills": patch
---

Make `/setup-skills` friendlier and align the local-markdown tracker with the current spec.
...
Docs pages for `setup-skills` and `to-tickets` re-synced.
