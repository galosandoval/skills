...
- **[ask-galo](./ask-galo/SKILL.md)** — Ask which skill or flow fits your situation. A router over the user-invoked skills in this repo.
...
- **[to-spec](./to-spec/SKILL.md)** — Turn the current conversation into a spec and write it to a markdown file in the repo.
